<template>
    <div class="flex w-full h-screen flex-col-reverse md:flex-row">
        <!-- left side -->
            ...
            <div class="modal-main bg-white w-11/12 max-w-md mx-auto rounded-lg z-50 overflow-y-auto max-h-full">
                <div v-if="showModal === 'step1'">
                    <div class="pl-1 pr-4 py-1 h-12">
                        <button @click="setSignUpStep('step2')" class="rounded-full bg-blue font-bold text-white mt-2 p-1 pl-3 pr-3 relative right-0 float-right hover:bg-darkblue" :class="`${!uname || !email || !birthdate ? 'opacity-50 cursor-not-allowed':''}`">Next</button>
                    ...
                    <div class="pt-5 px-8">
                        ...
                        <input v-model="uname" class="w-full bg-lightblue text-lg" type="text">
                        </div>
                        <div class="w-full bg-lightblue border-b-2 border-dark mb-8 p-2">
                ...
                <div v-if="showModal === 'step4'">
                    ...
                    <div class="pt-5 px-8">
                        ...
                        <input v-model="uname" class="w-full py-2 bg-lightblue text-lg" type="text">
                        </div>
                        <div class="w-full bg-lightblue border-b-2 border-dark mb-6 p-2">
...
<script setup lang="ts">
    ...
    function setSignUpStep(step : string) {
        switch(step){
            case 'step2':
            if (!uname.value || !email.value || !birthdate.value) {
                return;
            }
            break;
            case 'step4':
